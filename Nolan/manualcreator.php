...
?>
    ...
    <div class="modecrea">
		...
		<div id="buttonjs">
			<div class = "buttonsCrea">
				...
				<button id="verif" class="boutoncrea" onClick="verifCreator()">Verification</button>
        ...
        <div id="creator">
			<div class= "title">MANUAL CREATOR</div>
			<div id="dim">
        ...
        <div id="creator2">
            ...
            <div class='choix'>
				<div class="count"> Current Object </div>
				<div id="currentCrea"></div>
            </div>
            <div class="allchoix">

				<div class='choix'>
				<div class = "case block"></div>
				<div class = "case teleporter"></div>
				</div>
				<div class='choix'>
				<div class = "case perso1"></div>
    ...
    <script src="js/manualcreator.js"></script>
</body>
</html>
